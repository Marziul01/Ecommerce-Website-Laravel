...
@section('title')
    {{ $siteSettings->title }} | Sub Category
@endsection
    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                ...
                <span></span> <a href="{{ route('categoryProduct', $sub_category->category->slug) }}" rel="nofollow">{{ $sub_category->category->name }}</a>
                <span></span> {{ $sub_category->name }}
            </div>
        </div>
    </div>
