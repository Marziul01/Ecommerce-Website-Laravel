                ...
                <div class="col-md-4 mb-4">
                    <div class="card shadow-sm position-relative">
                        ...
                        <div class="position-absolute top-0 end-0 m-2">
                            ...
                            @if ($admin->status == 1)
                                <form action="{{ route('admin.control.status' , $admin->id) }}" method="POST" class="d-inline " onsubmit="return confirm('Are you sure you want to block this admin?');">
                                    @csrf
                            ...
                            @else
                                <form action="{{ route('admin.control.status' , $admin->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to activate this admin?');">
                                    @csrf
                            ...
                            @endif
                            <form action="{{ route('admin.control.delete' , $admin->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this admin ?');">
                                @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-2">
                                @if ($currentaccess)
                                    @foreach ($currentaccess->getAttributes() as $key => $val)
                                        @if ($val == 3 && $key !== 'id' && $key !== 'admin_id' && $key !== 'created_at' && $key !== 'updated_at' && $key !== 'control_panel')
                            ...
                            <div class="mb-2">
                                @if ($currentaccess)
                                    @foreach ($currentaccess->getAttributes() as $key => $val)
                                        @if ($val == 1 && $key !== 'id' && $key !== 'admin_id' && $key !== 'created_at' && $key !== 'updated_at' && $key !== 'control_panel')
                            ...
                            <div class="mb-2">
                                @if ($currentaccess)
                                    @foreach ($currentaccess->getAttributes() as $key => $val)
                                        @if ($val == 2 && $key !== 'id' && $key !== 'admin_id' && $key !== 'created_at' && $key !== 'updated_at' && $key !== 'control_panel')
                            ...
                            <form class="edit-admin-form" data-id="{{ $admin->id }}" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        @if ($currentaccess)
                                            @foreach ($currentaccess->getAttributes() as $key => $val)
                                                @if ($key !== 'id' && $key !== 'admin_id' && $key !== 'created_at' && $key !== 'updated_at' && $key !== 'control_panel')
                                                    <div class="col-md-4">
